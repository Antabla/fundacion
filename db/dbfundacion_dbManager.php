...
function getConnection() {
	...
	global $db_fundacion_db_Url, $db_fundacion_db_User, $db_fundacion_db_Pass, $db_fundacion_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_fundacion_db_Url.";dbname=".$db_fundacion_db_DbName, $db_fundacion_db_User, $db_fundacion_db_Pass);
