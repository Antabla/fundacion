...
$app->post('/user',	function () use ($app){
	...
	$obj = makeQuery("INSERT INTO user (_id, mail, password, role, username )  VALUES ( null, :mail, :password, :role, :username   )", $params, false);
...
$app->post('/user/:id',	function ($id) use ($app){
	...
	$obj = makeQuery("UPDATE user SET  mail = :mail,  password = :password,  role = :role,  username = :username   WHERE _id = :id LIMIT 1", $params, false);
